<div class='auction losing'>
    ...
    <button class='last1 grey raise' id='raise<?php echo $asta["IDProdotto"]?>'>RAISE</button><button class='last2 grey' id='addCart<?php echo $asta["IDProdotto"]?>'>BUY NOW</button>
